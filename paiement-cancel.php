...
if (empty($ref_payment)) {
    $_SESSION['error'] = "Informations de paiement manquantes.";
    header("Location: mes_reservations.php");
    exit;
}

// Vérifier la réservation dans la base de données
try {
    ...
    $_SESSION['info'] = "Votre paiement a été annulé. Vous pouvez réessayer ultérieurement.";
    header("Location: paiement.php?id=" . $reservation['id']);
    exit;
    
} catch (PDOException $e) {
    $_SESSION['error'] = "Erreur lors de la vérification de la réservation: " . $e->getMessage();
    header("Location: mes_reservations.php");
    exit;
}
?>
